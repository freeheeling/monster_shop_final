...
RSpec.describe 'As a Merchant Admin' do
  before(:each) do
    ...
    @merchant_admin = @meg.users.create(name: 'Admin', email: 'bobemail.com', password: 'secure', role: 2)
    ...
    @order_1 = @user_1.orders.create(name: 'User 1', address_id: @address_1.id, status: 'Pending')
    @order_2 = @user_1.orders.create(name: 'User 1', address_id: @address_1.id, status: 'Pending')
